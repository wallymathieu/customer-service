...
namespace Customers
{
    ...
    {
        [OperationContract(Action = "http://tempuri.org/ICustomerService/GetCustomers", ReplyAction = "http://tempuri.org/ICustomerService/GetCustomersResponse")]
        Task<ArrayOfCustomer> GetCustomersAsync(string lastName);
        [OperationContract(Action = "http://tempuri.org/ICustomerService/GetCustomerByAccountNumber", ReplyAction = "http://tempuri.org/ICustomerService/GetCustomerByAccountNumberResponse")]
